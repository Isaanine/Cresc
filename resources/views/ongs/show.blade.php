...
<div x-show="open" @click.away="open = false" class="fixed inset-0 flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative  flex-col sm:flex-row">
        ...
        <div class="flex justify-between items-center mb-4">
            <h4 class="text-lg font-bold">Nome do Curso</h4>
            <!-- Close Button -->
        ...
        <p class="text-sm mb-4">
                <strong>Professor:</strong> Fulano<br>
                <strong>Duração:</strong> 35-40 min - Segunda a Sexta<br>
                <strong>Itens necessários para as aulas:</strong><br>
                xxxx - xxxxx - xxxxx
            </p>
